...
public class EXP : MonoBehaviour
{
    ...
    // Значения монет за убийство разных типов мобов
    ...
    void Start()
    {
        // Загрузка сохраненных данных при старте игры (если есть)
        LoadData();
        UpdateUI();
    }
    ...
    // Добавление очков после убийства моба
    public void AddPoints(string mobType)
    {
        // Увеличение монет и очков в зависимости от типа моба
    ...
    // Добавление очков после выживания волны
    ...
    // Сохранение данных в JSON при выходе из игры
